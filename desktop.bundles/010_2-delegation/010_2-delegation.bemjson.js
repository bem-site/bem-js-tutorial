    ...
    content:[
        {
            ...
            content: [
                ...
                [
                    ...
                    'var params = function() { return { translate: { prompt: \'две курицы\'}}};',
                    'phrase.onclick=params;',
                    ...
                    'var params = function() { return { translate: { prompt: \'бегут впереди петуха\'}}};',
                    'phrase.onclick=params;',
                    'container.appendChild(phrase);',
                    ...
                    'var params = function() { return { translate: { prompt: \'кудахчет одна курица другой\'}}};',
                    'phrase.onclick=params;',
                    'container.appendChild(phrase);',
                    ...
                    'var params = function() { return { translate: { prompt: \'не так быстро\'}}};',
                    'phrase.onclick=params;',
                    'container.appendChild(phrase);',
                    ...
                    'var params = function() { return { translate: { prompt: \'он уже не так молод\'}}};',
                    'phrase.onclick=params;',
                    'container.appendChild(phrase);',
